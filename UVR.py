...
class MainWindow(TkinterDnD.Tk):
    ...
    def __init__(self):
        ...
        #pyglet.font.add_file("/usr/share/fonts/truetype/ancient-scripts/Symbola_hint.ttf")
        #self.font = tk.font.Font(size=10)
        self.font = tk.font.Font(family='Century Gothic', size=10)
        #self.fontRadio = tk.font.Font(size=8) 
    ...
    def create_widgets(self):
        ...
        self.command_Text = ThreadSafeConsole(master=self,
                                              background='#0e0e0f',fg='#898b8e', font=('Century Gothic', 11),borderwidth=1)
    ...
    def fill_filePaths_Frame(self):
        ...
        #ttk.Label(self.filePaths_Frame, background = "#F6F6F7", foreground = "#0e0e0f")
        #style = ttkthemes.ThemedStyle(self.filePaths_Frame)  # 设置需要设置主题的窗口
        ...
        #ttk.Label(master=self.filePaths_Frame, background = "#F6F6F7", foreground = "#0e0e0f")
        # Select Music Files Option
        ...
        #self.filePaths_Frame.pack()
        #ttk.Label(self.filePaths_Frame ,background='light green',foreground="black")
        # -Place Widgets-
    ...
    def open_file_filedialog(self):
        ...
        #tk.Label(self, bg = "#F6F6F7", fg = "#0e0e0f")
        #paths = tk.filedialog.askopenfilenames(title=f'Select Music Files', initialfile='', initialdir='')
        #ttk.Label(parent=self ,background='light green',foreground="black")
        paths = tk.filedialog.askopenfilenames(parent=self, title=f'Select Music Files', initialfile='',initialdir=self.lastDir,)
    ...
    def custom_ensemble(self):
        ...
        l0.grid(row=1,column=0,padx=0,pady=10, ipadx = 0)
...
if __name__ == "__main__":
    ...
    #style = ttk.Style()
    #root.tk.call("source", "/home/gao2020/personal_projects/ultimatevocalremovergui-5.4.0/themes/ttkthemes/ttkthemes/png/equilux/equilux.tcl")
    #root = _default_root
    #root.tk.call("set_theme", "equilux")
    #style.theme_use("equilux")

    #fttk_theme = ttkbs.Window(themename="superhero")
    
    lib_v5.sv_ttk.set_theme("dark")
    #lib_v5.sv_ttk.use_light_theme()  # Set dark theme
    ...
    #root.tk.call("lappend", "auto_path", "/home/gao2020/personal_projects/ultimatevocalremovergui-5.4.0/themes/ttkthemes/ttkthemes")

    #root.tk.call("package", "require", "blue")
